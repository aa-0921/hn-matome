# HackerNews 日本語まとめ & AI要約 MVP 実装計画
...
<head>
  ...
  <title>{% block title %}HackerNews 日本語まとめ & AI要約{% endblock %}</title>
  ...
  <meta property="og:title" content="{% block og_title %}HackerNews 日本語まとめ & AI要約{% endblock %}">
...
<body>
  <header class="site-header">
    <div class="container">
      <a href="/" class="site-title">HackerNews 日本語まとめ & AI要約</a>
      <nav class="site-nav">
        <a href="/">トップ</a>
...
{% block title %}{{ report.date_ja }} | HackerNews 日本語まとめ & AI要約{% endblock %}
...
{% block og_title %}{{ report.date_ja }} | HackerNews 日本語まとめ & AI要約{% endblock %}
...
<script type="application/ld+json">
{
  ...
  "author": {"@type": "Organization", "name": "HackerNews 日本語まとめ & AI要約"},
  "publisher": {"@type": "Organization", "name": "HackerNews 日本語まとめ & AI要約"},
  "inLanguage": "ja",
...
{% block title %}HackerNews 日本語まとめ & AI要約 - 毎日更新{% endblock %}
...
{% block content %}
<h1 class="page-title">HackerNews 日本語まとめ & AI要約</h1>
...
```html
{% extends "base.html" %}
{% block title %}About | HackerNews 日本語まとめ & AI要約{% endblock %}
{% block content %}
<h1>HackerNews 日本語まとめ & AI要約について</h1>
<p>HackerNews 日本語まとめ & AI要約は、世界最大級のテック系ニュースサイト <a href="https://news.ycombinator.com" target="_blank" rel="noopener">Hacker News</a> のトップ記事を、毎朝 JST 8時に自動で日本語翻訳・AI要約して公開するサービスです。</p>
<h2>提供内容</h2>
<ul>
...
```html
{% extends "base.html" %}
{% block title %}プライバシーポリシー | HackerNews 日本語まとめ & AI要約{% endblock %}
{% block content %}
<h1>プライバシーポリシー</h1>
<p>最終更新: 2026年3月26日</p>
<h2>取得する情報</h2>
...
```
GitHub Actions タブ → "HackerNews 日本語まとめ & AI要約 毎日更新" → "Run workflow"
```
